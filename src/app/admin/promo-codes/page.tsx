  ...
  return (
    <div className="mx-auto w-full max-w-4xl flex-1 px-6 py-8">
      ...
      <div className="mt-8">
        ...
        {promoCodes.length === 0 ? (
          <p className="mt-3 text-sm text-zinc-500">No promo codes yet.</p>
        ) : (
          <Card className="mt-3">
                        ...
                        <tr key={promoCode.id} className="border-b border-border-subtle last:border-0">
                          <td className="px-4 py-3">
                            ...
                            {promoCode.description && (
                              <p className="text-xs text-zinc-500">{promoCode.description}</p>
                            )}
                          </td>
                          <td className="px-4 py-3 text-zinc-700">{discountLabel(promoCode)}</td>
