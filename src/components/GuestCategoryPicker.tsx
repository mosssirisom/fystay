  ...
  return (
    <div ref={containerRef} className="relative flex-1">
      <button
        ...
        className="focus-ring flex w-full items-center gap-2 rounded-xl px-3 py-1 text-left hover:bg-surface-muted"
      >
            ...
            {ROWS.map((row) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => update(row.key, Math.min(row.max, value[row.key] + 1))}
