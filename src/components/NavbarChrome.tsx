    ...
    <NavToneContext.Provider value={isHome ? "hero" : "default"}>
      <header
        className={cn(
          ...
          // -mt-[84px]/lg:-mt-[111px] in page.tsx) - a negative-margin
          ...
          // ~84px below lg: and ~111px at lg: (measured directly - lg: is
          // taller because the desktop logo is Logo size="lg" with extra
          // tagline clearance for the "y" descender's swash, enlarged so
