...
export function ReportReviewButton({
  ...
  if (reported) {
    return <span className="shrink-0 text-xs text-stone-500">Reported</span>;
  }
  ...
  return (
    <>
      <button
        ...
        className="focus-ring flex shrink-0 items-center gap-1 rounded-lg px-1.5 py-1 text-xs text-stone-500 hover:bg-surface-muted hover:text-stone-600"
      >
